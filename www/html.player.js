...
(function() {
	window.addEventListener('pimp:begin', function (event) {
		console.log('html.player: pimp:begin [to be implemented]');
	});

	window.addEventListener('pimp:configure', function (event) {
		console.log('html.player: pimp:configure [to be implemented]');
	});

	window.addEventListener('pimp:play', function (event) {
		console.log('html.player: pimp:play [to be implemented]');
	});

	window.addEventListener('pimp:stop', function (event) {
		console.log('html.player: pimp:stop [to be implemented]');
	});

	window.addEventListener('pimp:stopped', function (event) {
		console.log('html.player: pimp:stopped [to be implemented]');
	});

	window.addEventListener('pimp:end', function (event) {
		console.log('html.player: pimp:end [to be implemented]');
	});
}());